    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-slate-50">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center font-black text-primary">₹</div>
        </div>
      </div>
    );
  }
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50 lg:bg-white">
        ...
        >
          <div className="text-center lg:text-left space-y-2">
            <div className="lg:hidden mx-auto w-16 h-16 bg-primary rounded-[2rem] flex items-center justify-center mb-6 shadow-xl shadow-primary/20">
